...
<body onload="login();">
<form action="${pageContext.request.contextPath}/user/doLogin.controller" method="post">
  ...
  <div class="logo">
    <div id="formwrapper">
      ...
      <form action="${pageContext.request.contextPath}/user/doLogin.controller" method="post" name="apLogin" id="apLogin">
        <fieldset>
          <legend>
            用户登录
          </legend>
